...
u8 DIO_voidGetPinValue(u8 Copy_u8Port,u8 Copy_u8PinNum)
{
	...
	{
	case DIO_u8_PORTA:
		u8_PinState=GET_BIT(PINA,Copy_u8PinNum);
	    break;
	case DIO_u8_PORTB:
		u8_PinState=GET_BIT(PINB,Copy_u8PinNum);
	    break;
	case DIO_u8_PORTC:
		u8_PinState=GET_BIT(PINC,Copy_u8PinNum);
	    break;
	case DIO_u8_PORTD:
		u8_PinState=GET_BIT(PIND,Copy_u8PinNum);
	    break;
	}
	return u8_PinState;
}
